...
mod tests {
    ...
    fn simple() -> Runner {
        Runner {
            input: read_input(2020, "11_simple"),
        }
    }

    #[test]
    fn simple_a() {
        assert_eq!(simple().run_a(), String::from("37"));
    }

    #[test]
    fn simple_b() {
        assert_eq!(simple().run_b(), String::from("26"));
    }

    #[test]
    fn real_a() {
        assert_eq!(new().run_a(), String::from("2277"));
    }

    #[test]
    fn real_b() {
        assert_eq!(new().run_b(), String::from("2066"));
    }
}
